...
export default async function HomePage() {
  ...
  return (
    <main>
      ...
      <section className="split-section" id="about"><div className="section-label"><p className="eyebrow">{home.welcomeEyebrow}</p><span>01</span></div><div className="split-section-content"><div className="split-section-copy"><h2>{home.welcomeTitle}</h2><p>{home.welcomeBody}</p><Link className="under-link" href="/keystatic">Read our story <span>↗</span></Link></div><div className="belonging-visual"><img src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1200&q=80" alt="Students gathered in a Bible study session" /></div></div></section>
