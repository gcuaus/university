...
export default async function HomePage() {
  ...
  return (
    <main>
      ...
      <header className="site-header"><Link className="brand" href="#top"><span className="seal">G</span><span><strong>{home.brand}</strong><small>{home.brandDescriptor}</small></span></Link><nav><Link href="/about">{home.navAbout}</Link><Link href="/programs">{home.navPrograms}</Link><Link href="/faculty">{home.navFaculty}</Link><span className="header-theme-toggle"><ThemeToggle /></span><Link className="nav-cta" href="/keystatic">{home.navApply} <span>↗</span></Link></nav></header>
