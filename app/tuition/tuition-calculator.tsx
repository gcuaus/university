...
export default function TuitionCalculator({ content }: { content: TuitionContent }) {
  ...
  return (
    <main className="tuition-page">
      ...
      <section className="tuition-principles"><div><p className="eyebrow">Simple & straightforward</p><h2>How GCUA financing works.</h2></div><div className="principle-grid"><article><span>01</span><h3>No qualifying required</h3><p>No credit check, grants, or government loans. GCUA finances every student directly.</p></article><article><span>02</span><h3>Choose your rhythm</h3><p>After the annual down payment, the remaining balance is divided evenly over 12 or 18 months.</p></article><article><span>03</span><h3>Prepay and save</h3><p>Pay the full year&apos;s tuition up front and receive a {content.discount}% discount on tuition.</p></article></div></section>
