...
export default function TuitionCalculator({ content }: { content: TuitionContent }) {
  ...
  return (
    <main className="tuition-page">
      <header className="directory-header tuition-header"><Link href="/" className="back-link">GCTSA <span>↗</span></Link><Link href="/keystatic" className="admin-link">Edit</Link></header>
      ...
      <footer><div><span className="seal small">G</span><p>Great Commission Theological Seminary of America<br />Truthful study. Faithful service.</p></div><span className="footer-admin"><Link href="/keystatic">Content manager</Link> · © 2026 GCTSA</span></footer>
    </main>
  );
}